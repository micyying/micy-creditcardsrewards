...
base=base.replaceAll('v2.16.0 · Mox 現金回贈與對帳','v2.17.0 · 分類與帳項修正');
...
const root=base.replace('src="./parser.js"','src="./parser-v2.17.0.js"').replace('src="./rewards.js"','src="./rewards-v2.17.0.js"').replace('src="./mox-rewards.js"','src="./mox-rewards-v2.17.0.js"').replace('src="./go-rewards.js"','src="./go-rewards-v2.17.0.js"').replaceAll("face:'../../cardimgs/","face:'cardimgs/").replaceAll('href="../v2.16.0/"','href="./versions/v2.16.0/"');
fs.writeFileSync('index.html',root);
fs.copyFileSync(dir+'/rewards.js','rewards-v2.17.0.js');
fs.copyFileSync(dir+'/parser.js','parser-v2.17.0.js');

fs.copyFileSync(dir+'/mox-rewards.js','mox-rewards-v2.17.0.js');

fs.copyFileSync(dir+'/go-rewards.js','go-rewards-v2.17.0.js');
