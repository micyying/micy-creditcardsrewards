...
base=base.replaceAll('v2.15.1 · Chill 商戶規則與對帳','v2.16.0 · Mox 現金回贈與對帳');
...
const root=base.replace('src="./parser.js"','src="./parser-v2.16.0.js"').replace('src="./rewards.js"','src="./rewards-v2.16.0.js"').replace('src="./mox-rewards.js"','src="./mox-rewards-v2.16.0.js"').replaceAll("face:'../../cardimgs/","face:'cardimgs/").replaceAll('href="../v2.15.1/"','href="./versions/v2.15.1/"');
fs.writeFileSync('index.html',root);
fs.copyFileSync(dir+'/rewards.js','rewards-v2.16.0.js');
fs.copyFileSync(dir+'/parser.js','parser-v2.16.0.js');

fs.copyFileSync(dir+'/mox-rewards.js','mox-rewards-v2.16.0.js');
