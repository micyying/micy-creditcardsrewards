...
base=base.replaceAll('v2.15.0 · Chill 逐筆回贈預測','v2.15.1 · Chill 商戶規則與對帳');
...
const root=base.replace('src="./parser.js"','src="./parser-v2.15.1.js"').replace('src="./rewards.js"','src="./rewards-v2.15.1.js"').replaceAll("face:'../../cardimgs/","face:'cardimgs/").replaceAll('href="../v2.15.0/"','href="./versions/v2.15.0/"');
fs.writeFileSync('index.html',root);
fs.copyFileSync(dir+'/rewards.js','rewards-v2.15.1.js');
fs.copyFileSync(dir+'/parser.js','parser-v2.15.1.js');
