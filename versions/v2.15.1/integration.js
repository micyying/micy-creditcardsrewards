...
settingsHTML=function(){return '<section class="panel"><b>v2.15.1 · Chill 商戶規則與對帳</b><p class="mini">依「Chill卡回贈分析」v2計算每筆理論現金及基本積分；門檻與HK$150上限按交易日曆月計算。已匯入紀錄會自動補算。</p><a href="../v2.15.0/">開啟 v2.15.0</a></section>'+originalSettingsHTML();};
