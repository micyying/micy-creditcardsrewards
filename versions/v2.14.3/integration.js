...
settingsHTML=function(){return '<section class="panel"><b>v2.14.3 · 月結摘要與回贈排序</b><p class="mini">總消費直接採用銀行 New Charges，並顯示結單年份及來源；回贈、退款、兌換、還款、零數及費用按固定次序合併顯示。</p><a href="../v2.14.2/">開啟 v2.14.2</a></section>'+originalSettingsHTML();};
